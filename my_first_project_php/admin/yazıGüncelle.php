...
<input type="hidden" name="yazar" value="<?php echo $_SESSION["adisoyadi"];?>">

</p>

<p>Yayın Tarihi : <input type="text" name="tarih" value="<?php
echo $kayit["tarih"];?>"></p>

<p>Yazı Başlığı : <input type="text" name="baslik" value="<?php
$kayit["baslik"];?>"></p>

<p>Yazı içeriği : <textarea name="yazi" style="width: 500px; height: 150px;"><?php echo $kayit["yazi"];?></textarea></p>
